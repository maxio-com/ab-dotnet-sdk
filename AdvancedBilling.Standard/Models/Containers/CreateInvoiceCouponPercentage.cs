// <copyright file="CreateInvoiceCouponPercentage.cs" company="APIMatic">
...
namespace AdvancedBilling.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<CreateInvoiceCouponPercentage>),
        new Type[] {
            typeof(MStringCase),
    ...
    public abstract class CreateInvoiceCouponPercentage
    {
        ...
        /// </summary>
        /// <returns>
        /// The CreateInvoiceCouponPercentage instance, wrapping the provided string value.
        /// </returns>
        public static CreateInvoiceCouponPercentage FromString(string mString)
        {
        ...
        /// </summary>
        /// <returns>
        /// The CreateInvoiceCouponPercentage instance, wrapping the provided double value.
        /// </returns>
        public static CreateInvoiceCouponPercentage FromPrecision(double precision)
        {
        ...
        private sealed class MStringCase : CreateInvoiceCouponPercentage, ICaseValue<MStringCase, string>
        {
        ...
        private sealed class PrecisionCase : CreateInvoiceCouponPercentage, ICaseValue<PrecisionCase, double>
        {

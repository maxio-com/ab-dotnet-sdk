// <copyright file="CreatePaymentProfileExpirationYear.cs" company="APIMatic">
...
namespace AdvancedBilling.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<CreatePaymentProfileExpirationYear>),
        new Type[] {
            typeof(NumberCase),
            typeof(MStringCase)
        },
    ...
    public abstract class CreatePaymentProfileExpirationYear
    {
        ...
        /// </summary>
        /// <returns>
        /// The CreatePaymentProfileExpirationYear instance, wrapping the provided int value.
        /// </returns>
        ...
        /// </summary>
        /// <returns>
        /// The CreatePaymentProfileExpirationYear instance, wrapping the provided string value.
        /// </returns>
        public static CreatePaymentProfileExpirationYear FromString(string mString)
        {
        ...
        private sealed class NumberCase : CreatePaymentProfileExpirationYear, ICaseValue<NumberCase, int>
        {
            public int _value;
        ...
        private sealed class MStringCase : CreatePaymentProfileExpirationYear, ICaseValue<MStringCase, string>
        {

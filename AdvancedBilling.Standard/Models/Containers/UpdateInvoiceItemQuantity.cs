// <copyright file="UpdateInvoiceItemQuantity.cs" company="APIMatic">
...
namespace AdvancedBilling.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<UpdateInvoiceItemQuantity>),
        new[] {
    ...
    public abstract class UpdateInvoiceItemQuantity
    {
        /// <summary>
        /// This is Precision case.
        /// </summary>
        /// <returns>
        /// The UpdateInvoiceItemQuantity instance, wrapping the provided double value.
        /// </returns>
        public static UpdateInvoiceItemQuantity FromPrecision(double precision)
        {
        ...
        /// </summary>
        /// <returns>
        /// The UpdateInvoiceItemQuantity instance, wrapping the provided string value.
        /// </returns>
        public static UpdateInvoiceItemQuantity FromString(string mString)
        {
        ...
        private sealed class PrecisionCase : UpdateInvoiceItemQuantity, ICaseValue<PrecisionCase, double>
        {
            public double Value;
        ...
        private sealed class MStringCase : UpdateInvoiceItemQuantity, ICaseValue<MStringCase, string>
        {
            public string Value;

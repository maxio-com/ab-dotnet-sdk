// <copyright file="CloneComponentPricePointPricePointId.cs" company="APIMatic">
...
namespace AdvancedBilling.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<CloneComponentPricePointPricePointId>),
        new[] {
            typeof(NumberCase),
            typeof(MStringCase)
        },
    ...
    public abstract class CloneComponentPricePointPricePointId
    {
        ...
        /// </summary>
        /// <returns>
        /// The CloneComponentPricePointPricePointId instance, wrapping the provided int value.
        /// </returns>
        ...
        /// </summary>
        /// <returns>
        /// The CloneComponentPricePointPricePointId instance, wrapping the provided string value.
        /// </returns>
        public static CloneComponentPricePointPricePointId FromString(string mString)
        {
        ...
        private sealed class NumberCase : CloneComponentPricePointPricePointId, ICaseValue<NumberCase, int>
        {
            public int Value;
        ...
        private sealed class MStringCase : CloneComponentPricePointPricePointId, ICaseValue<MStringCase, string>
        {
            public string Value;

// <copyright file="ScheduledRenewalUpdateRequestRenewalConfigurationItem.cs" company="APIMatic">
...
namespace AdvancedBilling.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<ScheduledRenewalUpdateRequestRenewalConfigurationItem>),
        new[] {
    ...
    public abstract class ScheduledRenewalUpdateRequestRenewalConfigurationItem
    {
        ...
        /// </summary>
        /// <returns>
        /// The ScheduledRenewalUpdateRequestRenewalConfigurationItem instance, wrapping the provided ScheduledRenewalItemRequestBodyComponent value.
        /// </returns>
        public static ScheduledRenewalUpdateRequestRenewalConfigurationItem FromScheduledRenewalItemRequestBodyComponent(ScheduledRenewalItemRequestBodyComponent scheduledRenewalItemRequestBodyComponent)
        {
        ...
        /// </summary>
        /// <returns>
        /// The ScheduledRenewalUpdateRequestRenewalConfigurationItem instance, wrapping the provided ScheduledRenewalItemRequestBodyProduct value.
        /// </returns>
        public static ScheduledRenewalUpdateRequestRenewalConfigurationItem FromScheduledRenewalItemRequestBodyProduct(ScheduledRenewalItemRequestBodyProduct scheduledRenewalItemRequestBodyProduct)
        {
        ...
        private sealed class ScheduledRenewalItemRequestBodyComponentCase : ScheduledRenewalUpdateRequestRenewalConfigurationItem, ICaseValue<ScheduledRenewalItemRequestBodyComponentCase, ScheduledRenewalItemRequestBodyComponent>
        {
        ...
        private sealed class ScheduledRenewalItemRequestBodyProductCase : ScheduledRenewalUpdateRequestRenewalConfigurationItem, ICaseValue<ScheduledRenewalItemRequestBodyProductCase, ScheduledRenewalItemRequestBodyProduct>
        {

// <copyright file="UpdatePriceUnitPrice.cs" company="APIMatic">
...
namespace AdvancedBilling.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<UpdatePriceUnitPrice>),
        new Type[] {
    ...
    public abstract class UpdatePriceUnitPrice
    {
        ...
        /// </summary>
        /// <returns>
        /// The UpdatePriceUnitPrice instance, wrapping the provided double value.
        /// </returns>
        ...
        /// </summary>
        /// <returns>
        /// The UpdatePriceUnitPrice instance, wrapping the provided string value.
        /// </returns>
        public static UpdatePriceUnitPrice FromString(string mString)
        {
        ...
        private sealed class PrecisionCase : UpdatePriceUnitPrice, ICaseValue<PrecisionCase, double>
        {
        ...
        private sealed class MStringCase : UpdatePriceUnitPrice, ICaseValue<MStringCase, string>
        {

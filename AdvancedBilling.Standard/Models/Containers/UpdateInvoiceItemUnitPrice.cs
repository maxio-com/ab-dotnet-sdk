// <copyright file="UpdateInvoiceItemUnitPrice.cs" company="APIMatic">
...
namespace AdvancedBilling.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<UpdateInvoiceItemUnitPrice>),
        new[] {
    ...
    public abstract class UpdateInvoiceItemUnitPrice
    {
        /// <summary>
        /// This is Precision case.
        /// </summary>
        /// <returns>
        /// The UpdateInvoiceItemUnitPrice instance, wrapping the provided double value.
        /// </returns>
        public static UpdateInvoiceItemUnitPrice FromPrecision(double precision)
        {
        ...
        /// </summary>
        /// <returns>
        /// The UpdateInvoiceItemUnitPrice instance, wrapping the provided string value.
        /// </returns>
        public static UpdateInvoiceItemUnitPrice FromString(string mString)
        {
        ...
        private sealed class PrecisionCase : UpdateInvoiceItemUnitPrice, ICaseValue<PrecisionCase, double>
        {
            public double Value;
        ...
        private sealed class MStringCase : UpdateInvoiceItemUnitPrice, ICaseValue<MStringCase, string>
        {
            public string Value;

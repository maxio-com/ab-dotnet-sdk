// <copyright file="MeteredUsageNewUnitBalance.cs" company="APIMatic">
...
namespace AdvancedBilling.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<MeteredUsageNewUnitBalance>),
        new[] {
            typeof(NumberCase),
            typeof(MStringCase)
        },
    ...
    public abstract class MeteredUsageNewUnitBalance
    {
        /// <summary>
        /// This is Number case.
        /// </summary>
        /// <returns>
        /// The MeteredUsageNewUnitBalance instance, wrapping the provided int value.
        /// </returns>
        public static MeteredUsageNewUnitBalance FromNumber(int number)
        {
        ...
        /// </summary>
        /// <returns>
        /// The MeteredUsageNewUnitBalance instance, wrapping the provided string value.
        /// </returns>
        public static MeteredUsageNewUnitBalance FromString(string mString)
        {
        ...
        private sealed class NumberCase : MeteredUsageNewUnitBalance, ICaseValue<NumberCase, int>
        {
            public int Value;
        ...
        private sealed class MStringCase : MeteredUsageNewUnitBalance, ICaseValue<MStringCase, string>
        {
            public string Value;

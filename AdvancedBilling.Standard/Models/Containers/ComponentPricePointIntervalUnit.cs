...
namespace AdvancedBilling.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<ComponentPricePointIntervalUnit>),
        new Type[] {
            typeof(IntervalUnitCase)
        },
        true
    )]
    public abstract class ComponentPricePointIntervalUnit
    {
        /// <summary>
        /// This is Interval Unit case.
        /// </summary>
        /// <returns>
        /// The ComponentPricePointIntervalUnit instance, wrapping the provided IntervalUnit value.
        /// </returns>
        public static ComponentPricePointIntervalUnit FromIntervalUnit(IntervalUnit intervalUnit)
        {
        ...
        private sealed class IntervalUnitCase : ComponentPricePointIntervalUnit, ICaseValue<IntervalUnitCase, IntervalUnit>
        {

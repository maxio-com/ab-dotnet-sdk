...
namespace AdvancedBilling.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<CustomerChangeShippingAddress>),
        new Type[] {
            typeof(AddressChangeCase)
        },
        true
    )]
    public abstract class CustomerChangeShippingAddress
    {
        /// <summary>
        /// This is Address Change case.
        /// </summary>
        /// <returns>
        /// The CustomerChangeShippingAddress instance, wrapping the provided AddressChange value.
        /// </returns>
        public static CustomerChangeShippingAddress FromAddressChange(AddressChange addressChange)
        {
        ...
        private sealed class AddressChangeCase : CustomerChangeShippingAddress, ICaseValue<AddressChangeCase, AddressChange>
        {

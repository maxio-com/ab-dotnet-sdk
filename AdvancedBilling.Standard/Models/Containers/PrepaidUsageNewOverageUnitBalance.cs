// <copyright file="PrepaidUsageNewOverageUnitBalance.cs" company="APIMatic">
...
namespace AdvancedBilling.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<PrepaidUsageNewOverageUnitBalance>),
        new[] {
            typeof(NumberCase),
            typeof(MStringCase)
        },
    ...
    public abstract class PrepaidUsageNewOverageUnitBalance
    {
        /// <summary>
        /// This is Number case.
        /// </summary>
        /// <returns>
        /// The PrepaidUsageNewOverageUnitBalance instance, wrapping the provided int value.
        /// </returns>
        public static PrepaidUsageNewOverageUnitBalance FromNumber(int number)
        {
        ...
        /// </summary>
        /// <returns>
        /// The PrepaidUsageNewOverageUnitBalance instance, wrapping the provided string value.
        /// </returns>
        public static PrepaidUsageNewOverageUnitBalance FromString(string mString)
        {
        ...
        private sealed class NumberCase : PrepaidUsageNewOverageUnitBalance, ICaseValue<NumberCase, int>
        {
            public int Value;
        ...
        private sealed class MStringCase : PrepaidUsageNewOverageUnitBalance, ICaseValue<MStringCase, string>
        {
            public string Value;

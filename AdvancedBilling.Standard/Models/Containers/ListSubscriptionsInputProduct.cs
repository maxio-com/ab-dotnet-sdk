// <copyright file="ListSubscriptionsInputProduct.cs" company="APIMatic">
...
namespace AdvancedBilling.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<ListSubscriptionsInputProduct>),
        new[] {
            typeof(NumberCase),
            typeof(MStringCase)
        },
    ...
    public abstract class ListSubscriptionsInputProduct
    {
        /// <summary>
        /// This is Number case.
        /// </summary>
        /// <returns>
        /// The ListSubscriptionsInputProduct instance, wrapping the provided int value.
        /// </returns>
        public static ListSubscriptionsInputProduct FromNumber(int number)
        {
        ...
        /// </summary>
        /// <returns>
        /// The ListSubscriptionsInputProduct instance, wrapping the provided string value.
        /// </returns>
        public static ListSubscriptionsInputProduct FromString(string mString)
        {
        ...
        private sealed class NumberCase : ListSubscriptionsInputProduct, ICaseValue<NumberCase, int>
        {
            public int Value;
        ...
        private sealed class MStringCase : ListSubscriptionsInputProduct, ICaseValue<MStringCase, string>
        {
            public string Value;

// <copyright file="ListUsagesInputSubscriptionIdOrReference.cs" company="APIMatic">
...
namespace AdvancedBilling.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<ListUsagesInputSubscriptionIdOrReference>),
        new[] {
            typeof(NumberCase),
            typeof(MStringCase)
        },
    ...
    public abstract class ListUsagesInputSubscriptionIdOrReference
    {
        /// <summary>
        /// This is Number case.
        /// </summary>
        /// <returns>
        /// The ListUsagesInputSubscriptionIdOrReference instance, wrapping the provided int value.
        /// </returns>
        public static ListUsagesInputSubscriptionIdOrReference FromNumber(int number)
        {
        ...
        /// </summary>
        /// <returns>
        /// The ListUsagesInputSubscriptionIdOrReference instance, wrapping the provided string value.
        /// </returns>
        public static ListUsagesInputSubscriptionIdOrReference FromString(string mString)
        {
        ...
        private sealed class NumberCase : ListUsagesInputSubscriptionIdOrReference, ICaseValue<NumberCase, int>
        {
            public int Value;
        ...
        private sealed class MStringCase : ListUsagesInputSubscriptionIdOrReference, ICaseValue<MStringCase, string>
        {
            public string Value;

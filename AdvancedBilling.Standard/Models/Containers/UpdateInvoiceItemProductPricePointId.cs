// <copyright file="UpdateInvoiceItemProductPricePointId.cs" company="APIMatic">
...
namespace AdvancedBilling.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<UpdateInvoiceItemProductPricePointId>),
        new[] {
            typeof(MStringCase),
            typeof(NumberCase)
        },
    ...
    public abstract class UpdateInvoiceItemProductPricePointId
    {
        /// <summary>
        /// This is String case.
        /// </summary>
        /// <returns>
        /// The UpdateInvoiceItemProductPricePointId instance, wrapping the provided string value.
        /// </returns>
        public static UpdateInvoiceItemProductPricePointId FromString(string mString)
        {
        ...
        /// </summary>
        /// <returns>
        /// The UpdateInvoiceItemProductPricePointId instance, wrapping the provided int value.
        /// </returns>
        public static UpdateInvoiceItemProductPricePointId FromNumber(int number)
        {
        ...
        private sealed class MStringCase : UpdateInvoiceItemProductPricePointId, ICaseValue<MStringCase, string>
        {
            public string Value;
        ...
        private sealed class NumberCase : UpdateInvoiceItemProductPricePointId, ICaseValue<NumberCase, int>
        {
            public int Value;

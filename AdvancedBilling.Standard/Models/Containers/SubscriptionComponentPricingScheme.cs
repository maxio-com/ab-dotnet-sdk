...
namespace AdvancedBilling.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<SubscriptionComponentPricingScheme>),
        new Type[] {
            typeof(PricingSchemeCase)
        },
        true
    )]
    public abstract class SubscriptionComponentPricingScheme
    {
        /// <summary>
        /// This is Pricing Scheme case.
        /// </summary>
        /// <returns>
        /// The SubscriptionComponentPricingScheme instance, wrapping the provided PricingScheme value.
        /// </returns>
        public static SubscriptionComponentPricingScheme FromPricingScheme(PricingScheme pricingScheme)
        {
        ...
        private sealed class PricingSchemeCase : SubscriptionComponentPricingScheme, ICaseValue<PricingSchemeCase, PricingScheme>
        {

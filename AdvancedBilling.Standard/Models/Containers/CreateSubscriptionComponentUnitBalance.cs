// <copyright file="CreateSubscriptionComponentUnitBalance.cs" company="APIMatic">
...
namespace AdvancedBilling.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<CreateSubscriptionComponentUnitBalance>),
        new[] {
            typeof(NumberCase),
            typeof(MStringCase)
        },
    ...
    public abstract class CreateSubscriptionComponentUnitBalance
    {
        /// <summary>
        /// This is Number case.
        /// </summary>
        /// <returns>
        /// The CreateSubscriptionComponentUnitBalance instance, wrapping the provided int value.
        /// </returns>
        public static CreateSubscriptionComponentUnitBalance FromNumber(int number)
        {
        ...
        /// </summary>
        /// <returns>
        /// The CreateSubscriptionComponentUnitBalance instance, wrapping the provided string value.
        /// </returns>
        public static CreateSubscriptionComponentUnitBalance FromString(string mString)
        {
        ...
        private sealed class NumberCase : CreateSubscriptionComponentUnitBalance, ICaseValue<NumberCase, int>
        {
            public int Value;
        ...
        private sealed class MStringCase : CreateSubscriptionComponentUnitBalance, ICaseValue<MStringCase, string>
        {
            public string Value;

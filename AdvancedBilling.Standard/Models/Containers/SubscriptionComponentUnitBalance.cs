// <copyright file="SubscriptionComponentUnitBalance.cs" company="APIMatic">
...
namespace AdvancedBilling.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<SubscriptionComponentUnitBalance>),
        new[] {
            typeof(NumberCase),
            typeof(MStringCase)
        },
    ...
    public abstract class SubscriptionComponentUnitBalance
    {
        /// <summary>
        /// This is Number case.
        /// </summary>
        /// <returns>
        /// The SubscriptionComponentUnitBalance instance, wrapping the provided int value.
        /// </returns>
        public static SubscriptionComponentUnitBalance FromNumber(int number)
        {
        ...
        /// </summary>
        /// <returns>
        /// The SubscriptionComponentUnitBalance instance, wrapping the provided string value.
        /// </returns>
        public static SubscriptionComponentUnitBalance FromString(string mString)
        {
        ...
        private sealed class NumberCase : SubscriptionComponentUnitBalance, ICaseValue<NumberCase, int>
        {
            public int Value;
        ...
        private sealed class MStringCase : SubscriptionComponentUnitBalance, ICaseValue<MStringCase, string>
        {
            public string Value;

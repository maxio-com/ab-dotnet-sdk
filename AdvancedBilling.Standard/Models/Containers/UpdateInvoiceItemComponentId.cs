// <copyright file="UpdateInvoiceItemComponentId.cs" company="APIMatic">
...
namespace AdvancedBilling.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<UpdateInvoiceItemComponentId>),
        new[] {
            typeof(MStringCase),
            typeof(NumberCase)
        },
    ...
    public abstract class UpdateInvoiceItemComponentId
    {
        /// <summary>
        /// This is String case.
        /// </summary>
        /// <returns>
        /// The UpdateInvoiceItemComponentId instance, wrapping the provided string value.
        /// </returns>
        public static UpdateInvoiceItemComponentId FromString(string mString)
        {
        ...
        /// </summary>
        /// <returns>
        /// The UpdateInvoiceItemComponentId instance, wrapping the provided int value.
        /// </returns>
        public static UpdateInvoiceItemComponentId FromNumber(int number)
        {
        ...
        private sealed class MStringCase : UpdateInvoiceItemComponentId, ICaseValue<MStringCase, string>
        {
            public string Value;
        ...
        private sealed class NumberCase : UpdateInvoiceItemComponentId, ICaseValue<NumberCase, int>
        {
            public int Value;

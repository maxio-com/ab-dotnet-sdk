// <copyright file="MeteredComponentUnitPrice.cs" company="APIMatic">
...
namespace AdvancedBilling.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<MeteredComponentUnitPrice>),
        new Type[] {
            typeof(MStringCase),
    ...
    public abstract class MeteredComponentUnitPrice
    {
        ...
        /// </summary>
        /// <returns>
        /// The MeteredComponentUnitPrice instance, wrapping the provided string value.
        /// </returns>
        public static MeteredComponentUnitPrice FromString(string mString)
        {
        ...
        /// </summary>
        /// <returns>
        /// The MeteredComponentUnitPrice instance, wrapping the provided double value.
        /// </returns>
        ...
        private sealed class MStringCase : MeteredComponentUnitPrice, ICaseValue<MStringCase, string>
        {
        ...
        private sealed class PrecisionCase : MeteredComponentUnitPrice, ICaseValue<PrecisionCase, double>
        {

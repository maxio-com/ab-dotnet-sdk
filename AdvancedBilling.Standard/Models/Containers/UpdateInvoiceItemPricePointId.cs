// <copyright file="UpdateInvoiceItemPricePointId.cs" company="APIMatic">
...
namespace AdvancedBilling.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<UpdateInvoiceItemPricePointId>),
        new[] {
            typeof(MStringCase),
            typeof(NumberCase)
        },
    ...
    public abstract class UpdateInvoiceItemPricePointId
    {
        /// <summary>
        /// This is String case.
        /// </summary>
        /// <returns>
        /// The UpdateInvoiceItemPricePointId instance, wrapping the provided string value.
        /// </returns>
        public static UpdateInvoiceItemPricePointId FromString(string mString)
        {
        ...
        /// </summary>
        /// <returns>
        /// The UpdateInvoiceItemPricePointId instance, wrapping the provided int value.
        /// </returns>
        public static UpdateInvoiceItemPricePointId FromNumber(int number)
        {
        ...
        private sealed class MStringCase : UpdateInvoiceItemPricePointId, ICaseValue<MStringCase, string>
        {
            public string Value;
        ...
        private sealed class NumberCase : UpdateInvoiceItemPricePointId, ICaseValue<NumberCase, int>
        {
            public int Value;

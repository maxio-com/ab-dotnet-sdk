// <copyright file="ListUsagesInputComponentId.cs" company="APIMatic">
...
namespace AdvancedBilling.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<ListUsagesInputComponentId>),
        new Type[] {
            typeof(NumberCase),
            typeof(MStringCase)
        },
    ...
    public abstract class ListUsagesInputComponentId
    {
        ...
        /// </summary>
        /// <returns>
        /// The ListUsagesInputComponentId instance, wrapping the provided int value.
        /// </returns>
        ...
        /// </summary>
        /// <returns>
        /// The ListUsagesInputComponentId instance, wrapping the provided string value.
        /// </returns>
        public static ListUsagesInputComponentId FromString(string mString)
        {
        ...
        private sealed class NumberCase : ListUsagesInputComponentId, ICaseValue<NumberCase, int>
        {
            public int _value;
        ...
        private sealed class MStringCase : ListUsagesInputComponentId, ICaseValue<MStringCase, string>
        {

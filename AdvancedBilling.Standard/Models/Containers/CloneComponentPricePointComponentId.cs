// <copyright file="CloneComponentPricePointComponentId.cs" company="APIMatic">
...
namespace AdvancedBilling.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<CloneComponentPricePointComponentId>),
        new[] {
            typeof(NumberCase),
            typeof(MStringCase)
        },
    ...
    public abstract class CloneComponentPricePointComponentId
    {
        /// <summary>
        /// This is Number case.
        /// </summary>
        /// <returns>
        /// The CloneComponentPricePointComponentId instance, wrapping the provided int value.
        /// </returns>
        public static CloneComponentPricePointComponentId FromNumber(int number)
        {
        ...
        /// </summary>
        /// <returns>
        /// The CloneComponentPricePointComponentId instance, wrapping the provided string value.
        /// </returns>
        public static CloneComponentPricePointComponentId FromString(string mString)
        {
        ...
        private sealed class NumberCase : CloneComponentPricePointComponentId, ICaseValue<NumberCase, int>
        {
            public int Value;
        ...
        private sealed class MStringCase : CloneComponentPricePointComponentId, ICaseValue<MStringCase, string>
        {
            public string Value;

// <copyright file="UpdateInvoiceItemProductId.cs" company="APIMatic">
...
namespace AdvancedBilling.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<UpdateInvoiceItemProductId>),
        new[] {
            typeof(MStringCase),
            typeof(NumberCase)
        },
    ...
    public abstract class UpdateInvoiceItemProductId
    {
        /// <summary>
        /// This is String case.
        /// </summary>
        /// <returns>
        /// The UpdateInvoiceItemProductId instance, wrapping the provided string value.
        /// </returns>
        public static UpdateInvoiceItemProductId FromString(string mString)
        {
        ...
        /// </summary>
        /// <returns>
        /// The UpdateInvoiceItemProductId instance, wrapping the provided int value.
        /// </returns>
        public static UpdateInvoiceItemProductId FromNumber(int number)
        {
        ...
        private sealed class MStringCase : UpdateInvoiceItemProductId, ICaseValue<MStringCase, string>
        {
            public string Value;
        ...
        private sealed class NumberCase : UpdateInvoiceItemProductId, ICaseValue<NumberCase, int>
        {
            public int Value;

// <copyright file="SegmentSegmentProperty4Value.cs" company="APIMatic">
...
namespace AdvancedBilling.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<SegmentSegmentProperty4Value>),
        new Type[] {
            typeof(MStringCase),
    ...
    public abstract class SegmentSegmentProperty4Value
    {
        ...
        /// </summary>
        /// <returns>
        /// The SegmentSegmentProperty4Value instance, wrapping the provided string value.
        /// </returns>
        public static SegmentSegmentProperty4Value FromString(string mString)
        {
        ...
        /// </summary>
        /// <returns>
        /// The SegmentSegmentProperty4Value instance, wrapping the provided double value.
        /// </returns>
        ...
        /// </summary>
        /// <returns>
        /// The SegmentSegmentProperty4Value instance, wrapping the provided int value.
        /// </returns>
        ...
        /// </summary>
        /// <returns>
        /// The SegmentSegmentProperty4Value instance, wrapping the provided bool value.
        /// </returns>
        public static SegmentSegmentProperty4Value FromBoolean(bool boolean)
        {
        ...
        private sealed class MStringCase : SegmentSegmentProperty4Value, ICaseValue<MStringCase, string>
        {
        ...
        private sealed class PrecisionCase : SegmentSegmentProperty4Value, ICaseValue<PrecisionCase, double>
        {
        ...
        private sealed class NumberCase : SegmentSegmentProperty4Value, ICaseValue<NumberCase, int>
        {
            public int _value;
        ...
        private sealed class BooleanCase : SegmentSegmentProperty4Value, ICaseValue<BooleanCase, bool>
        {
            public bool _value;

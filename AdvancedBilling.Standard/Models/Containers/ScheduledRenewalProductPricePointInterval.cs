// <copyright file="ScheduledRenewalProductPricePointInterval.cs" company="APIMatic">
...
namespace AdvancedBilling.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<ScheduledRenewalProductPricePointInterval>),
        new[] {
            typeof(MStringCase),
            typeof(NumberCase)
        },
    ...
    public abstract class ScheduledRenewalProductPricePointInterval
    {
        /// <summary>
        /// This is String case.
        /// </summary>
        /// <returns>
        /// The ScheduledRenewalProductPricePointInterval instance, wrapping the provided string value.
        /// </returns>
        public static ScheduledRenewalProductPricePointInterval FromString(string mString)
        {
        ...
        /// </summary>
        /// <returns>
        /// The ScheduledRenewalProductPricePointInterval instance, wrapping the provided int value.
        /// </returns>
        public static ScheduledRenewalProductPricePointInterval FromNumber(int number)
        {
        ...
        private sealed class MStringCase : ScheduledRenewalProductPricePointInterval, ICaseValue<MStringCase, string>
        {
            public string Value;
        ...
        private sealed class NumberCase : ScheduledRenewalProductPricePointInterval, ICaseValue<NumberCase, int>
        {
            public int Value;

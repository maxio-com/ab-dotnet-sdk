// <copyright file="SubscriptionCustomPriceExpirationInterval.cs" company="APIMatic">
...
namespace AdvancedBilling.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<SubscriptionCustomPriceExpirationInterval>),
        new Type[] {
            typeof(MStringCase),
            typeof(NumberCase)
        },
    ...
    public abstract class SubscriptionCustomPriceExpirationInterval
    {
        ...
        /// </summary>
        /// <returns>
        /// The SubscriptionCustomPriceExpirationInterval instance, wrapping the provided string value.
        /// </returns>
        public static SubscriptionCustomPriceExpirationInterval FromString(string mString)
        {
        ...
        /// </summary>
        /// <returns>
        /// The SubscriptionCustomPriceExpirationInterval instance, wrapping the provided int value.
        /// </returns>
        ...
        private sealed class MStringCase : SubscriptionCustomPriceExpirationInterval, ICaseValue<MStringCase, string>
        {
        ...
        private sealed class NumberCase : SubscriptionCustomPriceExpirationInterval, ICaseValue<NumberCase, int>
        {
            public int _value;

// <copyright file="PrepaidUsageNewUnitBalance.cs" company="APIMatic">
...
namespace AdvancedBilling.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<PrepaidUsageNewUnitBalance>),
        new[] {
            typeof(NumberCase),
            typeof(MStringCase)
        },
    ...
    public abstract class PrepaidUsageNewUnitBalance
    {
        /// <summary>
        /// This is Number case.
        /// </summary>
        /// <returns>
        /// The PrepaidUsageNewUnitBalance instance, wrapping the provided int value.
        /// </returns>
        public static PrepaidUsageNewUnitBalance FromNumber(int number)
        {
        ...
        /// </summary>
        /// <returns>
        /// The PrepaidUsageNewUnitBalance instance, wrapping the provided string value.
        /// </returns>
        public static PrepaidUsageNewUnitBalance FromString(string mString)
        {
        ...
        private sealed class NumberCase : PrepaidUsageNewUnitBalance, ICaseValue<NumberCase, int>
        {
            public int Value;
        ...
        private sealed class MStringCase : PrepaidUsageNewUnitBalance, ICaseValue<MStringCase, string>
        {
            public string Value;

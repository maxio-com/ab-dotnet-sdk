// <copyright file="CurrencyOveragePrices.cs" company="APIMatic">
...
namespace AdvancedBilling.Standard.Models
{
    ...
    /// </summary>
    public class CurrencyOveragePrices : BaseModel
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CurrencyOveragePrices"/> class.
        /// </summary>
        public CurrencyOveragePrices()
        {
        }
        ...
        /// <param name="currencyOveragePricesProp">currency_overage_prices.</param>
        public CurrencyOveragePrices(
            int? id = null,
            ...
            List<Models.ComponentCurrencyPrice> currencyOveragePricesProp = null)
        {
            this.Id = id;
            this.Type = type;
            ...
            this.CurrencyOveragePricesProp = currencyOveragePricesProp;
        }
        ...
        /// </summary>
        [JsonProperty("currency_overage_prices", NullValueHandling = NullValueHandling.Ignore)]
        public List<Models.ComponentCurrencyPrice> CurrencyOveragePricesProp { get; set; }
        ...
        public override string ToString()
        {
            ...
            return $"CurrencyOveragePrices : ({string.Join(", ", toStringOutput)})";
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is CurrencyOveragePrices other &&
                ...
                (this.CurrencyOveragePricesProp == null && other.CurrencyOveragePricesProp == null ||
                 this.CurrencyOveragePricesProp?.Equals(other.CurrencyOveragePricesProp) == true) &&
                base.Equals(obj);
        }
        ...
        protected new void ToString(List<string> toStringOutput)
        {
            ...
            toStringOutput.Add($"CurrencyOveragePricesProp = {(this.CurrencyOveragePricesProp == null ? "null" : $"[{string.Join(", ", this.CurrencyOveragePricesProp)} ]")}");

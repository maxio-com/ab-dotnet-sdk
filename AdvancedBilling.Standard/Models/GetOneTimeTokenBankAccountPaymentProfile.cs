// <copyright file="GetOneTimeTokenBankAccountPaymentProfile.cs" company="APIMatic">
...
namespace AdvancedBilling.Standard.Models
{
    ...
    /// </summary>
    public class GetOneTimeTokenBankAccountPaymentProfile : BaseModel
    {
        private string id;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetOneTimeTokenBankAccountPaymentProfile"/> class.
        /// </summary>
        ...
        public GetOneTimeTokenBankAccountPaymentProfile(
            string firstName,
            string lastName,
            Models.BankAccountVault currentVault,
            string vaultToken,
            ...
            Models.BankAccountType bankAccountType,
            Models.BankAccountHolderType bankAccountHolderType,
            string paymentType,
            bool disabled,
        ...
        /// </summary>
        [JsonProperty("bank_account_holder_type")]
        [JsonRequired]
        ...
        public override string ToString()
        {
            ...
            return $"GetOneTimeTokenBankAccountPaymentProfile : ({string.Join(", ", toStringOutput)})";
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is GetOneTimeTokenBankAccountPaymentProfile other &&
                ...
                (this.BankAccountHolderType.Equals(other.BankAccountHolderType)) &&
        ...
        protected new void ToString(List<string> toStringOutput)
        {
            ...
            toStringOutput.Add($"BankAccountHolderType = {this.BankAccountHolderType}");

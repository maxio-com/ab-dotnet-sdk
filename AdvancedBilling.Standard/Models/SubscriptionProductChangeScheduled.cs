// <copyright file="SubscriptionProductChangeScheduled.cs" company="APIMatic">
...
namespace AdvancedBilling.Standard.Models
{
    ...
    /// </summary>
    public class SubscriptionProductChangeScheduled : BaseModel
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SubscriptionProductChangeScheduled"/> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            return $"SubscriptionProductChangeScheduled : ({string.Join(", ", toStringOutput)})";
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is SubscriptionProductChangeScheduled other &&

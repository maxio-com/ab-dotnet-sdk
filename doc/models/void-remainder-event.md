...
| `EventType` | [`InvoiceEventType`](../../doc/models/invoice-event-type.md) | Required | **Default**: `InvoiceEventType.void_remainder` |
...
VoidRemainderEvent voidRemainderEvent = new VoidRemainderEvent
{
    Id = 198L,

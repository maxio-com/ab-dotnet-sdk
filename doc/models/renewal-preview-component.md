...
RenewalPreviewComponent renewalPreviewComponent = new RenewalPreviewComponent
{
    ComponentId = RenewalPreviewComponentComponentId.FromString("String1"),
    Quantity = 254,
    PricePointId = RenewalPreviewComponentPricePointId.FromString("String7"),
};
```

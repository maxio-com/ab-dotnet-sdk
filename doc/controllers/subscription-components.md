...
catch (ApiException e)
{
    ...
    {
       // TODO: Handle ComponentPricePointErrorException exception here
    }
}
```
...
CreateAllocationRequest body = new CreateAllocationRequest
{
    Allocation = new CreateAllocation
    {
        ...
        AccrueCharge = false,
        PricePointId = CreateAllocationPricePointId.FromNumber(789),
        BillingSchedule = new BillingSchedule
        {
            InitialBillingAt = DateTime.Parse("2025-02-28"),
        },
        CustomPrice = new ComponentCustomPrice
        {
            Prices = new List<Price>
            {
                new Price
                {
                    ...
                    UnitPrice = PriceUnitPrice.FromString("49.00"),
                    EndingQuantity = PriceEndingQuantity.FromNumber(25),
                },
                new Price
                {
                    StartingQuantity = PriceStartingQuantity.FromNumber(26),
                    UnitPrice = PriceUnitPrice.FromString("39.00"),
                    EndingQuantity = null,
                },
            },
            TaxIncluded = false,
...
catch (ApiException e)
{
    ...
    {
       // TODO: Handle ComponentAllocationErrorException exception here
    }
}
```
...
catch (ApiException e)
{
    ...
    {
       // TODO: Handle SubscriptionComponentAllocationErrorException exception here
    }
}
```
